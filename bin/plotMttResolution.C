{
  ...
  tree->Draw("(mtt_after_kf-MC_mtt)>>mtt_after_kf", "kf_converged", "sames");
  tree->Draw("(mtt_after_kf-MC_mtt)>>mtt_after_kf_with_cut", "kf_converged && (kf_proba > 0.2)", "sames");
  tree->Draw("(mtt_after_kf-MC_mtt)>>mtt_after_kf_with_cut_weighted", "(kf_converged && (kf_proba > 0.2)) * kf_proba", "sames");
