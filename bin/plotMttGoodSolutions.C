{
  ...
  tree->Draw("mtt>>mtt");
  tree->Draw("mtt_after_kf>>mtt_after_kf", "", "sames");
  tree->Draw("mtt_after_kf>>mtt_after_kf_with_cut", "(kf_proba > 0.2)", "sames");
  tree->Draw("mtt_after_kf>>mtt_after_kf_with_cut_weighted", "((kf_proba > 0.2)) * kf_proba", "sames");
