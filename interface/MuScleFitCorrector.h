#ifndef MUSCLEFITCORRECTOR
#define MUSCLEFITCORRECTOR
...
class MuScleFitCorrector
{
 ...
 protected:
  ...
  void readParameters(const TString& fileName){
    ...
    switch ( scaleFunctionNum ) {
      case ( 50 ): scaleFunction_ = new scaleFunction50<double * > ; break;
      default: std::cout << "scaleFunctionService error: wrong identifier = " << scaleFunctionNum << std::endl; exit(1);
    }
	resolutionFunctionId_ = resolutionFunctionNum;
	//resolutionFunction_ = resolutionFunctionService(resolutionFunctionNum);
    switch ( resolutionFunctionNum ) {
      case ( 45 ): resolutionFunction_ = new resolutionFunction45<double * > ; break;
      case ( 46 ): resolutionFunction_ = new resolutionFunction46<double * > ; break;
      case ( 57 ): resolutionFunction_ = new resolutionFunction57<double * > ; break;
      default: std::cout << "resolutionFunctService error: wrong identifier = " << resolutionFunctionNum << std::endl; exit(1);
    }
