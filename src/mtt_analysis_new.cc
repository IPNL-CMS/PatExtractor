...
#include "Extractors/PatExtractor_2/interface/AnalysisSettings.h"
#include "Extractors/PatExtractor_2/interface/MCExtractor.h"
#include "Extractors/PatExtractor_2/interface/MuonExtractor.h"
#include "Extractors/PatExtractor_2/interface/ElectronExtractor.h"
#include "Extractors/PatExtractor_2/interface/JetExtractor.h"
#include "Extractors/PatExtractor_2/interface/METExtractor.h"
#include "Extractors/PatExtractor_2/interface/VertexExtractor.h"
#include "Extractors/PatExtractor_2/interface/KinFit.h"
#include "Extractors/PatExtractor_2/interface/EventExtractor.h"
...
void mtt_analysis_new::loopOverCombinations(bool do_MC_)
{
  ...
  if (m_mtt_NumComb > 0)
  {
     ...
     */
    m_mLepTop_AfterChi2 = (*m_jet->getJetLorentzVector(bestj2) + *m_refLept + *m_MET->getMETLorentzVector(0)).M();
    m_mHadTop_AfterChi2 = (*m_jet->getJetLorentzVector(bestj1) + *m_jet->getJetLorentzVector(bestj3) + *m_jet->getJetLorentzVector(bestj4)).M();
    m_mtt_AfterChi2     = (*m_jet->getJetLorentzVector(bestj2) + *m_refLept + *m_MET->getMETLorentzVector(0) + *m_jet->getJetLorentzVector(bestj1) + *m_jet->getJetLorentzVector(bestj3) + *m_jet->getJetLorentzVector(bestj4)).M();
